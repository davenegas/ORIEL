...
/** 
 * Esta clase maneja todos los métodos relacionados con t_recepcion_parqueobitacora
 * Clase generada automáticamente el 2019-02-20 08:04
 * Base de datos: bd_gerencia_seguridad
 * Generada por:  
 */ 
class cls_recepcion_parqueobitacora {
    /**
     * Columna [ID_RecepcionParqueoBitacora] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Llave primaria de la tabla 
     */
    public $ID_RecepcionParqueoBitacora;
    /**
     * Columna [ID_RecepcionParqueo] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Llave foranea a tabla T_Recepcion_Parqueo 
     */
    public $ID_RecepcionParqueo;
    /**
     * Columna [ID_Recepcion_Apertura] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Llave foranea a tabla T_Recepcion_Apertura 
     */
    public $ID_Recepcion_Apertura;
    /**
     * Columna [ID_Persona] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Llave foranea a tabla T_Personal 
     */
    public $ID_Persona;
    /**
     * Columna [ID_Ubicacion] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Llave foranea a tabla T_Recepcion_Ubicacion 
     */
    public $ID_Ubicacion;
    /**
     * Columna [ID_Tipo_Vehiculo] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Llave foranea a tabla T_Recepcion_Tipovehiculo 
     */
    public $ID_Tipo_Vehiculo;
    /**
     * Columna [Nombre] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Nombre de la persona dueña del espacio de parqueo 
     */
    public $Nombre;
    /**
     * Columna [Es_Prestamo] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Muestra sí el lugar esta en prestamo 
     */
    public $Es_Prestamo;
    /**
     * Columna [Prestamo] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Nombre de la persona dueña a la que se presta el parqueo 
     */
    public $Prestamo;
    /**
     * Columna [Num_Lugar] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Número de lugar en el parqueo 
     */
    public $Num_Lugar;
    /**
     * Columna [Es_Externo] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Es personal del banco o externo 
     */
    public $Es_Externo;
    /**
     * Columna [Cedula] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Cédula de identidad de la persona que ocupa el espacio en el parqueo 
     */
    public $Cedula;
    /**
     * Columna [Placa] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Número de placa 
     */
    public $Placa;
    /**
     * Columna [Fecha_Entrada] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Fecha de entrada al parqueo 
     */
    public $Fecha_Entrada;
    /**
     * Columna [Hora_Entrada] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Hora de entrada al parqueo 
     */
    public $Hora_Entrada;
    /**
     * Columna [Fecha_Salida] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Fecha de salida del parqueo 
     */
    public $Fecha_Salida;
    /**
     * Columna [Hora_Salida] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Hora de salida del parqueo 
     */
    public $Hora_Salida;
    /**
     * Columna [Estado_Uso] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
     * Estado de uso D=Disponible O= Ocupado N=No disponible por alguna falla 
     */
    public $Estado_Uso;
    /**
     * Columna [Estado] de la tabla [t_recepcion_parqueobitacora] en la clase [cls_recepcion_parqueobitacora] 
    ...
    /**
     *Retorna el valor de la propiedad ID_RecepcionParqueoBitacora
     */
    function getID_RecepcionParqueoBitacora() {
        return $this->ID_RecepcionParqueoBitacora;
    }
     ...
     * Retorna el valor de la propiedad ID_RecepcionParqueoBitacora
     */
    function setID_RecepcionParqueoBitacora($ID_RecepcionParqueoBitacora) {
        $this->ID_RecepcionParqueoBitacora = $ID_RecepcionParqueoBitacora;
    }
    ...
    /**
     * Constructor: inicializa las variables de la clase cls_recepcion_parqueobitacora
     */
    public function __construct() {
        $this->ID_RecepcionParqueoBitacora="";
     ...
     */
    public function obtener_recepcion_parqueobitacora() {
        if($this->condicion==""){
            $this->obj_data_provider->conectar();
            $this->arreglo=$this->obj_data_provider->trae_datos("t_recepcion_parqueobitacora", "*", $this->condicion);
     ...
     */
    public function guardar_recepcion_parqueobitacora() {
        $this->obj_data_provider->conectar();
        if ($this->ID_RecepcionParqueoBitacora==0){
            $this->obj_data_provider->inserta_datos("t_recepcion_parqueobitacora","ID_RecepcionParqueo, ID_Recepcion_Apertura, ID_Persona, ID_Ubicacion, ID_Tipo_Vehiculo, Nombre, Es_Prestamo, Prestamo, Num_Lugar, Es_Externo, Cedula, Placa, Fecha_Entrada, Hora_Entrada, Fecha_Salida, Hora_Salida, Estado_Uso, Estado","'".$this->ID_RecepcionParqueo."','".$this->ID_Recepcion_Apertura."','".$this->ID_Persona."','".$this->ID_Ubicacion."','".$this->ID_Tipo_Vehiculo."','".$this->Nombre."','".$this->Es_Prestamo."','".$this->Prestamo."','".$this->Num_Lugar."','".$this->Es_Externo."','".$this->Cedula."','".$this->Placa."','".$this->Fecha_Entrada."','".$this->Hora_Entrada."','".$this->Fecha_Salida."','".$this->Hora_Salida."','".$this->Estado_Uso."','".$this->Estado."'");
        }else{
            $this->obj_data_provider->edita_datos("t_recepcion_parqueobitacora","ID_RecepcionParqueo='".$this->ID_RecepcionParqueo."',ID_Recepcion_Apertura='".$this->ID_Recepcion_Apertura."',ID_Persona='".$this->ID_Persona."',ID_Ubicacion='".$this->ID_Ubicacion."',ID_Tipo_Vehiculo='".$this->ID_Tipo_Vehiculo."',Nombre='".$this->Nombre."',Es_Prestamo='".$this->Es_Prestamo."',Prestamo='".$this->Prestamo."',Num_Lugar='".$this->Num_Lugar."',Es_Externo='".$this->Es_Externo."',Cedula='".$this->Cedula."',Placa='".$this->Placa."',Fecha_Entrada='".$this->Fecha_Entrada."',Hora_Entrada='".$this->Hora_Entrada."',Fecha_Salida='".$this->Fecha_Salida."',Hora_Salida='".$this->Hora_Salida."',Estado_Uso='".$this->Estado_Uso."',Estado='".$this->Estado."'",$this->condicion);
        }
        $this->obj_data_provider->desconectar();
        $this->resultado_operacion=true;
    }
     ...
     */
    public function cambiar_estado_recepcion_parqueobitacora(){
        $this->obj_data_provider->conectar();
        $this->obj_data_provider->edita_datos("t_recepcion_parqueobitacora","Estado='".$this->Estado."'",$this->condicion);
        $this->obj_data_provider->desconectar();
    }
    /*******************************************************************/
     ...
     * utiliza la propiedad condicion para filtrar en el WHERE 
     */
    public function obtener_recepcion_reporte() {
        if($this->condicion==""){
            $this->obj_data_provider->conectar();
            $this->arreglo=$this->obj_data_provider->trae_datos("t_recepcion_parqueobitacora p inner join t_recepcion_ubicacion u on p.ID_Ubicacion = u.ID_Ubicacion ".
                    "inner join t_recepcion_tipovehiculo t on p.ID_Tipo_Vehiculo = t.ID_Tipo_Vehiculo ORDER BY p.Num_Lugar asc", 
                    "p.ID_RecepcionParqueo, p.ID_Recepcion_Apertura, p.ID_Persona, CASE WHEN p.Es_Prestamo = '1' THEN 'SÍ' ELSE 'NO' END Es_Prestamo, ".
