  ...
  public function obtiene_todos_los_descansos(){
   ...
   public function guardar_descansos() {
       ...
       $this->obj_data_provider->desconectar();
           ...
           $this->obj_data_provider->conectar();
       $this->arreglo=$this->obj_data_provider->edita_datos("t_ajus_descanso", "Duracion_Descanso='".$this->Duracion_descanso."',Observaciones='".$this->Observaciones."',Estado='".$this->estado."'", "ID_Ajus_Descanso=".$this->ID_Ajus_Descanso);
       $this->arreglo=$this->obj_data_provider->getArreglo();
       $this->obj_data_provider->desconectar();
       }
