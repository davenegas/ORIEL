    ...
    <body>
        ...
        <section class="container">
            <div class="container">
                ...
                <p>Informacion general del botón nuevo:</p>
                </div>
            </div> 
            <br> 
            ...
            <div class="container">
            <div class="col-sm-4">
                <label for="id_puntobcr">Punto BCR<a id="popup" onclick="...()" class="btn azul" role="button">(Agencia)</a></label>   
                <input hidden type="text" id="id_puntobcr" name="id_puntobcr" value="<?php echo $params[0]['ID_PuntoBCR'];?>">
                <input type="text" readonly="readonly" class="form-control" id="oficina" name="oficina" value="<?php echo $params[0]['Nombre'];?>">
            </div>
            <div class="col-sm-4">
