...
<html lang="es">
    ...
    <body>
        ...
        <div class="container">
            <!--Botones para navegación entre un punto y otro-->
            ...
            <!--Ubicación del Punto BCR: Provincia, Cantón, Distrito, Dirección-->
            <div> 
                <header>
