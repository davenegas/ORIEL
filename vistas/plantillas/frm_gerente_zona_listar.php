...
<html lang="es">
    <head>
        <meta charset="utf-8"/>
        <title>Lista de Gerentes de Zona</title>
        ...
        <script>
            ...
            function guardar_gerente() {
                document.getElementById('ID_Gerente_Zona').value="0";
                document.getElementById('nombre2').value=null;
                document.getElementById('zona_gerencia2').value=null;
    ...
    <body>
        ...
        <div class="container">
            <h2>Listado General de Gerente de Zona BCR</h2>
            <p>A continuación se detallan los diferentes Gerentes que están registrados en el sistema por Zona:</p>            
            <table id="tabla" class="display" cellspacing="0">
                <thead>
                    <tr>
                        <th style="text-align:center">Zona de Gerente</th>
                        <th style="text-align:center">Nombre del Gerente</th>
                ...
                <tbody>
                    ...
                    for ($i = 0; $i <$tam; $i++) {  ?>
                        <tr>
                            <td><?php echo $params[$i]['Zona_Gerencia_BCR'];?></td>
                            ...
                            <?php }?>
                            <td style="text-align:center"><a href="index.php?ctl=gerente_zona_cambiar_estado&id=<?php echo $params[$i]['ID_Gerente_Zona']?>&estado=<?php echo $params[$i]['Estado']?>">
                                Activar/Desactivar</a></td>
                            <td style="text-align:center"><a role="button" onclick="editar_gerente('<?php echo $params[$i]['ID_Gerente_Zona'];?>',<?php echo $params [$i]['ID_Persona'];?>,
                                '<?php echo $params [$i]['Zona_Gerencia_BCR'];?>','<?php echo $params [$i]['Observaciones'];?>')">
                                Editar</a></td>
                        </tr>     
                    <?php } ?>
                </tbody>
            </table>
            <a id="popup" onclick="guardar_gerente()" class="btn btn-default" role="button">Agregar</a>
        </div>
        <?php require 'vistas/plantillas/pie_de_pagina.php' ?>
        <!--editar-->
        <div id="ventana_oculta_1"> 
            <div id="popupventana">
                <!--Formulario para editar gerente-->
                <form id="ventana" method="POST" name="form" action="index.php?ctl=gerente_zona_editar">
                    <img id="close" src='vistas/Imagenes/cerrar.png' width="25" onclick ="ocultar_elemento1()">
                    <h2>Gerente de Zona</h2>
                    <hr>
                    <input hidden id="ID_Gerente_Zona" name="ID_Gerente_Zona" type="text">
                    ...
                    <br>     
                    <label for="zona_gerencia">Zona del Gerente</label>
                    <input type="text" class="form-control espacio-abajo" id="zona_gerencia" name="zona_gerencia">  
        ...
        <div id="ventana_oculta_2"> 
            <div id="popupventana2">
                <!--Formulario para guardar gerente nuevo-->
                <form id="ventana2" method="POST" name="form" action="index.php?ctl=gerente_zona_guardar">
                    ...
                    <div class="form-group">
                        <label for="nombre2">Nombre del Gerente</label>
                    ...
                    <br>
                    <label for="zona_gerencia2">Zona de Gerencia</label>
                    <input type="text" class="form-control espacio-abajo" id="zona_gerencia2" name="zona_gerencia2" placeholder="Digite nueva Zona">
