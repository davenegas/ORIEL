...
<html lang="es">
     <head>
        ...
        <script>
            ...
            function editar_gerente(id_gz,nomb,num,obser,esta){
   ...
   <?php require_once 'encabezado.php';?>
    ...
    <tbody>
            ...
            ?>
            <tr>
                <!--<td><?php echo $params[$i]['ID_Gerente_Zona'];?></td>-->
            ...
            '<?php echo $params [$i]['Zona_Gerencia_BCR'];?>','<?php echo $params [$i]['Observaciones'];?>','<?php echo $params [$i]['Estado'];?>')">
        ...
        <div id="ventana_oculta_1"> 
            <div id="popupventana">
                ...
                <form id="ventana" method="POST" name="form" action="index.php?ctl=gerente_zona_editar">
                    ...
                    <input hidden id="ID_Gerenete_Zona" name="ID_Gerente_Zona" type="text">
                    ...
                    <br>     
                    <label for="numero">Zona del Gerente</label>
                    <select class="form-control" id="numero" name="numero">
                            ...
                            for($i=0; $i<$tam;$i++)
                            {  ?>
                            <option value="<?php echo $numero[$i]['Zona_Gerencia_BCR']?>"><?php echo $numero[$i]['Zona_Gerencia_BCR']?></option>   
                            <?php }  ?>
                            </select>
                    </div>
