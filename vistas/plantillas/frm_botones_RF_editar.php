...
<html lang="es">
    ...
    <body>
        ...
        <section class="container">
            <div class="container">
                <div class="col-sm-5"> 
                <h2>Edición de Botones</h2>
                <p>Información general botón programado:</p>
                </div>
            </div> 
            <br> 
            ...
            <div class="col-sm-4">
                ...
                <input hidden type="text" id="ID_PuntoBCR" name="ID_PuntoBCR" value="<?php echo $botones_rf[0]['ID_PuntoBCR'];?>">
                <input type="text" onfocus="buscar_punto()" class="form-control" id="oficina" name="oficina" value="<?php echo $botones_rf[0]['Nombre'];?>">
            </div>
            <div class="col-sm-4">
                ...
                <input hidden type="text" id="ID_Persona" name="ID_Persona" value="<?php echo $botones_rf[0]['ID_Persona'];?>">
                <input type="text" onfocus="buscar_persona()" class="form-control" id="funcionario" name="funcionario" value="<?php echo $botones_rf[0]['Apellido_Nombre'];?>">
            </div> 
            <div class="col-sm-4">
        ...
        <!--Formulario para Asignar Persona-->
