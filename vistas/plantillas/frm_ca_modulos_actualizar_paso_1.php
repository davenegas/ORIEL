...
<html lang="es">
    <head>
        <meta charset="utf-8"/>
        <title>Actualizar módulo puerta paso 1</title>
    ...
    <body>
        ...
        <div class="animated fadeIn">
            <h2>Listado de módulos contraladas Recibidas:</h2>
            
            <a href="index.php?ctl=actualizar_modulo_puerta_paso_2" class="btn btn-default espacio-abajo" role="button">Validar información</a>
